...
public class Courses {
    ...
    public Edge<CourseRequisite> putRequisite(CourseNumber courseNum1, 
        ...
        //implement this method
    		Vertex<CourseNumber> v1 = courseMap.get(courseNum1).getCourseVertex();
    		Vertex<CourseNumber> v2 = courseMap.get(courseNum2).getCourseVertex();
    		if (v1 == null || v2 == null) {
    			throw new InvalidCourseNumberException();
    		}
    		
    		Set<Vertex<CourseNumber>> map = new HashSet<>();
    		Map<Vertex<CourseNumber>, Edge<CourseRequisite>> forest = new ProbeHashMap<>();
    		DFS(courseGraph, v2, map, forest);
    		if (map.contains(v1)) {
    			throw new CircularPreRequisiteException();
    		}
    		
    		return courseGraph.insertEdge(v1, v2, requisite);	
   }
